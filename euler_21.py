...
for i in range(1, 10000):
    if amicable_dict[i] not in amicable_dict:
        amicable_dict[amicable_dict[i]] = sum_of_divisors(amicable_dict[i])
sum_amicable_numbers = 0
for i in range(1, 10000):
    if amicable_dict[amicable_dict[i]]==i and amicable_dict[i] != i:
        print(i)
